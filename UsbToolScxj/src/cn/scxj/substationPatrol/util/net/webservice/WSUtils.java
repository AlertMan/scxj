...
public class WSUtils {
	 ...
	 */
	public static String uploadTaskInfo(String userName,String taskId,String fileData) {
	 ...
	 * @return
	 */
	public static String uploadTaskDefectInfo(String userName,String taskDefectId,String fileData) {
	...
	public static String uploadAttachInfo(String taskType, String taskId,
			String attachId,String assetId,String fileData) {
