...
public class UserListAdapter extends ListAdapter {
	...
	public UserListAdapter(Context context, List<? extends Serializable> datas) {
		super(context, datas);
	}
	
	public UserListAdapter(Context context, List<? extends Serializable> datas,Handler mHandler) {
		this(context, datas);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.textView.setText(item.getREALNAME());
